...
<head>
	<title>{lang}wcf.guthaben.mainpage.recruitedby{/lang} - {lang}wcf.guthaben.pagetitle{/lang} - {PAGE_TITLE}</title>
...
<div id="main">
	...
	<div class="mainHeadline">
		<img src="{icon}guthabenRecruitedByL.png{/icon}" alt="" />
		<div class="headlineContainer">
			<h2>{lang}wcf.guthaben.mainpage.recruitedby{/lang}</h2>
			<p>{lang}wcf.guthaben.mainpage.recruitedby.description{/lang}</p>
		</div>
	</div>

	<div class="border content">
		<div class="container-1">
			{lang}wcf.guthaben.mainpage.recruitedby.link{/lang}
		</div>
	</div>
